#Purpose: Function to plot forest plots for all PLANT LEVEL models
#date started: 02/26/2025
#Author: LAS
#R version: 4.3.3.
...
#Total plot----
otf_list <- c(
  list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
             pattern = "^perc.dam", 
             full.names = TRUE),
  list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
             pattern = "^perc.dam", 
             full.names = TRUE)
)
...
ytf_list <- c(
  list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
             pattern = "^perc.dam", 
             full.names = TRUE),
  list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
             pattern = "^perc.dam", 
             full.names = TRUE)
)
...
otd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^total.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^total.div", 
...
ytd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^total.div", 
                         full.names = TRUE), 
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^total.div", 
...
otdplot <- otdplot +
  ...
  scale_y_discrete(labels = c("CMD", "EMT", "Eref", "MWMT", "DOY","TD", "Year"))+
...
otfplot <- otfplot +
  ...
  scale_y_discrete (labels = c("CMD", "EMT", "EXT", "MWMT", "DOY","TD", "Year"))+
  theme(legend.position = "none")
otfplot
...
ytdplot <- ytdplot +
  ...
  scale_y_discrete(labels = c("AHM", "CMI", "MAP", "MSP", "SHM", "DOY","Year"))+
  theme(legend.position = "none")
ytdplot
...
ytfplot <- ytfplot +
  ...
  scale_y_discrete(labels = c("AHM", "MAP", "MSP", "RH", "SHM", "DOY","Year"))+
  theme(legend.position = "none")
ytfplot
...
ytdplot80 <- ytdplot80 +
  labs(title = "Plant Level Richness of Total \nDamage (early-season)")+
  scale_y_discrete(labels = c("AHM", "CMI", "MAP", "MSP", "Year"))+
  theme(legend.position = "none")
ytdplot80
...
ytfplot80 <- ytfplot80 +
  labs(title = "Plant Level Frequency of Total \nDamage (early-season)")+
  scale_y_discrete(labels = c("AHM", "MAP"))+
  theme(legend.position = "none")
ytfplot80
...
opac_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                          pattern = "^leafperc_area_chew", 
                          full.names = TRUE),
               list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                          pattern = "^leafperc_area_chew", 
...
ypac_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                          pattern = "^leafperc_area_chew", 
                          full.names = TRUE),
               list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                          pattern = "^leafperc_area_chew", 
...
#chewing herbs "
ochew_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                           pattern = "^chewvalue", 
                           full.names = TRUE),
                list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                           pattern = "^chewvalue", 
...
ychew_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                           pattern = "^chewvalue", 
                           full.names = TRUE),
                list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                           pattern = "^chewvalue", 
...
ypacplot <- ypacplot +
  ...
  scale_y_discrete(labels=c("AHM", "CMI", "MAP", "MSP","RH", "DOY","Year"))+ #we are replacing the y-axis (cord flip in function)
  theme(legend.position = "none") 
ypacplot
...
ochewplot <- ochewplot +
  ...
  scale_y_discrete(labels=c("CMD", "Eref", "EXT", "MWMT", "DOY","TD","Year"))+ #we are replacing the y-axis (cord flip in function)
  theme(legend.position = "none") 
ochewplot
...
ypacplot80 <- ypacplot80 +
  labs(title = "Plant Level Percent Leaf Area \nChewed (early-season)") +
  scale_y_discrete(labels=c("AHM", "MAP", "DOY"))+ #we are replacing the y-axis (cord flip in function)
  theme(legend.position = "none") 
ypacplot80
...
#Specialized plot----
osf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^perc.spec", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^perc.spec", 
...
ysf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^perc.spec", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^perc.spec", 
...
osd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^spec.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^spec.div", 
...
ysd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^spec.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^spec.div", 
...
osdplot <- osdplot +
  ...
  scale_y_discrete(labels = c("CMD", "Eref", "EXT", "MWMT", "DOY", "TD", "Year"))+
  theme(legend.position = "none")
osdplot
...
osfplot <- osfplot +
  labs(title = "Plant Level  Frequency of \nSpecialized Damage (late-season)")+
  scale_y_discrete(labels = c("AHM", "EXT", "MAP", "MSP", "DOY", "TD","Year"))+
  theme(legend.position = "none")
osfplot
...
ysdplot <- ysdplot +
  ...
  scale_y_discrete(labels =c("AHM", "CMI", "MAP", "MSP", "RH", "DOY","Year"))+
  theme(legend.position = "none")
ysdplot
...
osdplot80 <- osdplot80 +
  labs(title = "Plant Level Richness of \nSpecialized Damage (late-season)")+
  scale_y_discrete(labels = c("MWMT", "TD"))+
  theme(legend.position = "none")
osdplot80
...
ysdplot80 <- ysdplot80 +
  labs(title = "Plant Level Richness of Specialized \nDamage (early-season)")+
  scale_y_discrete(labels =c("MAP", "Year"))+
  theme(legend.position = "none")
ysdplot80
...
#Mine plot----
opam_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
...
ypam_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                          pattern = "^leafperc_area_mine", 
                          full.names = TRUE),
               list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                          pattern = "^leafperc_area_mine", 
...
omf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^perc.mine", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^perc.mine", 
...
ymf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^perc.mine", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^perc.mine", 
...
omd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^mine.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^mine.div", 
...
ymd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^mine.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^mine.div", 
...
opamplot <- opamplot +
  ...
  scale_y_discrete(labels = c("CMD", "CMI", "EXT", "MWMT", "DOY","TD", "Year"))+
  theme(legend.position = "none")
opamplot
...
omdplot <- omdplot +
  ...
  scale_y_discrete(labels = c("AHM", "EXT", "MAP", "MSP", "SHM", "DOY","Year"))+
  theme(legend.position = "none")
omdplot
...
omfplot <- omfplot +
  labs(title = "Plant Level Frequency of \nMine Damage (late-season)")+
  scale_y_discrete(labels = c("DD_18", "DD5", "eFFP", "MAT", "NFFD", "DOY","Year"))+
  theme(legend.position = "none")
omfplot
...
ypamplot80 <- ypamplot80 +
  labs(title = "Plant Level Percent Leaf Area \nMined (early-season)") +
  scale_y_discrete(labels = c("MSP", "SHM"))+ 
  theme(legend.position = "none")
ypamplot80
...
omfplot80 <- omfplot80 +
  labs(title = "Plant Level Frequency of \nMine Damage (late-season)")+
  scale_y_discrete(labels = c("DD5", "eFFP", "MAT", "NFFD"))+
  theme(legend.position = "none")
omfplot80
...
ymdplot80 <- ymdplot80 +
  labs(title = "Plant Level Richness of \nMine Damage (early-season)")+
  scale_y_discrete(labels = c("SHM", "DOY"))+
  theme(legend.position = "none")
ymdplot80
...
ymfplot80 <- ymfplot80 +
  labs(title = "Plant Level Frequency of \nMine Damage (early-season)")+
  scale_y_discrete(labels = c("AHM", "MAP", "MSP", "Year"))+
  theme(legend.position = "none")
ymfplot80
...
# Gall plot----
opag_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
...
opag_names <- paste("Model", 1:9)
opag_names <- factor(opag_names, 
                     levels = paste("Model", 1:9),
                     ordered = TRUE)

ypag_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                          pattern = "^leafperc_area_gall", 
                          full.names = TRUE),
               list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                          pattern = "^leafperc_area_gall", 
...
ogf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^perc.gall", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^perc.gall", 
...
ygf_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^perc.gall", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^perc.gall", 
...
ogd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/old/year/", 
                         pattern = "^gall.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/old/doy/", 
                         pattern = "^gall.div", 
...
ygd_list <- c(list.files("Script_output/Brms/climate_models/p.lvl/young/year/", 
                         pattern = "^gall.div", 
                         full.names = TRUE),
              list.files("Script_output/Brms/climate_models/p.lvl/young/doy/", 
                         pattern = "^gall.div", 
...
ypagplot <- ypagplot +
  ...
  scale_y_discrete(labels = c("CMD", "Eref", "MAR", "MWMT", "RH", "DOY","Year"))+ 
  theme(legend.position = "none")
ypagplot
...
# gallplot80 <- plot_grid(NULL, ypagplot80,
#                         ogfplot80,NULL,
#                         ogdplot80,ygdplot80,
#                         nrow = 3,
#                         ncol = 2)
...
ggsave("figures/p.lvl/PL.totalbrms80_plot.pdf", totalplot80, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/PL.chewbrms80_plot.pdf", ypacplot80)
ggsave("figures/p.lvl/PL.specbrms80_plot.pdf", specplot80, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/PL.minebrms80_plot.pdf", mineplot80, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/PL.gallbrms80_plot.pdf", ygdplot80, height = 15, width = 13, units = "in")

#saving SI plots----
ggsave("figures/p.lvl/SI/PL.totalbrms_plot.pdf", totalplot, height = 15, width = 13, units = "in") #convert back to .png when the are "final" and ready for a manuscript
ggsave("figures/p.lvl/SI/PL.chewbrms_plot.pdf", chewplot, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/SI/PL.specbrms_plot.pdf", specplot, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/SI/PL.minebrms_plot.pdf", mineplot, height = 15, width = 13, units = "in")
ggsave("figures/p.lvl/SI/PL.gallbrms_plot.pdf", gallplot, height = 15, width = 13, units = "in")
