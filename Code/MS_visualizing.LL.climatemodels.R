...
ytdplot80 <- ytdplot80 +
  labs(title = "Richness of Total \nDamage (early-season)")+
  scale_y_discrete(labels = c("AHM", "CMI", "MAP", "Year"))+
  theme(legend.position = "none")
ytdplot80
...
opacplot <- opacplot +
  ...
  scale_y_discrete(labels=c("AHM", "DD_18", "DD5", "MAP", "MAT","DOY","Year"))+ #we are replacing the y-axis (cord flip in function)
  theme(legend.position = "none") 
opacplot
...
ychewplot <- ychewplot +
  ...
  scale_y_discrete(labels=c("AHM", "CMI", "MAP", "MSP","SHM", "DOY","Year"))+ #we are replacing the y-axis (cord flip in function)
  theme(legend.position = "none") 
ychewplot
...
osfplot80 <- osfplot80 +
  labs(title = "Frequency of \nSpecialized Damage (late-season)")+
  scale_y_discrete(labels = c("EMT", "TD","Year"))+
  theme(legend.position = "none")
osfplot80
...
ypamplot <- ypamplot +
  labs(title = "Percent Leaf Area \nMined (early-season)") +
  scale_y_discrete(labels = c("AHM", "CMI", "MAP", "MSP", "RH", "DOY","Year"))+ #MAR likely didn't converge
  theme(legend.position = "none")
ypamplot
...
omdplot <- omdplot +
  ...
  scale_y_discrete(labels = c("AHM", "MAP", "MAT", "MSP", "SHM","DOY","Year"))+
  theme(legend.position = "none")
omdplot
...
omfplot <- omfplot +
  labs(title = "Frequency of \nMine Damage (late-season)")+
  scale_y_discrete(labels = c("DD_18", "DD1040", "DD5", "MAT", "SHM", "DOY","Year"))+
  theme(legend.position = "none")
omfplot
...
ymdplot <- ymdplot +
  ...
  scale_y_discrete(labels = c("DD_0", "Eref", "MAP", "MSP", "RH","DOY","Year"))+
  theme(legend.position = "none")
ymdplot
...
ypamplot80 <- ypamplot80 +
  labs(title = "Percent Leaf Area \nMined (early-season)") +
  scale_y_discrete(labels = c("AHM", "CMI","MAP", "MSP", "DOY"))+ 
  theme(legend.position = "none")
ypamplot80
...
omdplot80 <- omdplot80 +
  labs(title = "Richness of \nMine Damage (late-season)")+
  scale_y_discrete(labels = c("AHM", "MAP", "MAT", "SHM"))+
  theme(legend.position = "none")
omdplot80
...
omfplot80 <- omfplot80 +
  labs(title = "Frequency of \nMine Damage (late-season)")+
  scale_y_discrete(labels = c("DD_18", "DD1040", "DD5", "MAT", "SHM", "Year"))+
  theme(legend.position = "none")
omfplot80
...
ymdplot80 <- ymdplot80 +
  labs(title = "Richness of \nMine Damage (early-season)")+
  scale_y_discrete(labels = c("DD_0", "RH"))+
  theme(legend.position = "none")
ymdplot80
...
opagplot <- opagplot +
  ...
  scale_y_discrete(labels = c("AHM", "MAP", "MSP", "MWMT", "DOY", "TD","Year"))+
  theme(legend.position = "none")
opagplot
...
ypagplot <- ypagplot +
  ...
  scale_y_discrete(labels = c("CMD", "DD18", "Eref", "MWMT","RH", "DOY","Year"))+ #AHM likely didn't converge
  theme(legend.position = "none")
ypagplot
...
ogdplot <- ogdplot +
  ...
  scale_y_discrete(labels = c("CMI", "EXT", "MAP", "MWMT", "DOY", "TD","Year"))+
  theme(legend.position = "none")
ogdplot
...
ogdplot80 <- ogdplot80 +
  labs(title = "Richness \nof Galls (late-season)")+
  scale_y_discrete(labels = c( "CMI", "MAP", "MWMT", "DOY", "TD"))+
  theme(legend.position = "none")
ogdplot80
